...
public final class Keys {
    ...
    /**
     * Path to the database driver JAR file. telescope includes drivers for MySQL, PostgreSQL and H2 databases. If you use
    ...
    /**
     * Database connection URL. By default telescope uses H2 database.
     */
    ...
    /**
     * Web interface TCP port number. By default telescope uses port 8082. To avoid specifying port in the browser you
    ...
    /**
     * telescope notification API key.
     */
    public static final ConfigKey<String> NOTIFICATOR_telescope_KEY = new ConfigKey<>(
            "notificator.telescope.key",
            Collections.singletonList(KeyType.GLOBAL));
     ...
     * specified value (in meters), then telescope will reuse last known address.
     */
     ...
     * location is not available. telescope can determine coordinates based on that information using third party
