...
public class Position extends Message {
    ...
    public static final String KEY_BATTERY_LEVEL = "battery_level"; // percentage
    public static final String KEY_FUEL_LEVEL = "fuel"; // liters
    public static final String KEY_FUEL_USED = "fuel_used"; // liters
    public static final String KEY_FUEL_CONSUMPTION = "fuel_consumption"; // liters/hour
