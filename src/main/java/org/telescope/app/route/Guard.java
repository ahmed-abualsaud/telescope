package org.telescope.app.route;

import static java.util.Arrays.asList;
import org.telescope.javel.framework.route.GuardManager;

public class Guard extends GuardManager {
     ...
     public Guard() {
        ...
        guards.put("public", asList(
         ...
         guards.put("admin", asList(
             ...
             "GET:/api/admin/last/position/by/device/id/{device_id}",
             "GET:/api/admin/last/position/by/device/unique/id/{unique_id}"
         ));
         ...
         guards.put("partner", asList(
             ...
             "GET:/api/partner/last/position/by/device/id/{device_id}",
             "GET:/api/partner/last/position/by/device/unique/id/{unique_id}",

             "GET:/api/partner/list/of/positions/by/device/id/{device_id}",
             "GET:/api/partner/list/of/positions/by/device/unique/id/{unique_id}",

             "GET:/api/partner/report/by/device/id/{device_id}",
             "GET:/api/partner/report/by/device/unique/id/{unique_id}",

             "GET:/api/partner/history/by/device/id/{device_id}",
             "GET:/api/partner/history/by/device/unique/id/{unique_id}",
             
             "GET:/api/partner/maintenance/by/device/id/{device_id}",
             "GET:/api/partner/maintenance/by/device/unique/id/{unique_id}",
             "POST:/api/partner/maintenance/by/device/id/{device_id}",
             "POST:/api/partner/maintenance/by/device/unique/id/{unique_id}",

             "GET:/api/partner/maintenance/types",
             "GET:/api/partner/maintenance/{maintenance_id}",
             "PUT:/api/partner/maintenance/{maintenance_id}",
             "DELETE:/api/partner/maintenance/{maintenance_id}"
         ));
         ...
         guards.put("user", asList(
             ...
             "GET:/api/user/last/position/by/device/id/{device_id}",
             "GET:/api/user/last/position/by/device/unique/id/{unique_id}"
         ));
