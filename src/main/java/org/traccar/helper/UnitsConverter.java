...
public final class UnitsConverter {
    ...
    private static final double METERS_PER_SECOND_TO_KNOTS_RATIO = 0.5144442571;
    ...
    public static double metersPerSecondFromKnots(double value) {
        return value * METERS_PER_SECOND_TO_KNOTS_RATIO;
    }
